...
(function ($) {
	$.fn.nthTabs =  function(options){
		...
		<a href="#" class="dropdown-toggle no-after" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">\
		<span class="fa fa-chevron-down"></span>\
		</a>\
		<ul class="dropdown-menu">\
		<li><a href="#" class="tab-location">按时间排序</a></li>\
		<li><a href="#" class="tab-close-current">按热度排序</a></li>\
		<hr/>\
